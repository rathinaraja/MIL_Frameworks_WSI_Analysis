        ...
        if np.random.rand() < prob:
            ...
            if i != j:
                ...
                if 'model' in mix_fn.__code__.co_varnames:
                    mixed_feat, mixed_label, _ = mix_fn(all_features[i], all_labels[i],all_features[j], all_labels[j],model, **mix_kwargs)
                else:
                    mixed_feat, mixed_label, _ = mix_fn(all_features[i], all_labels[i],all_features[j], all_labels[j],**mix_kwargs)
            else:
